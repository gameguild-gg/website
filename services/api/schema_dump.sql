...
CREATE UNIQUE INDEX "PK_648947e3e523dcf4c78ec8b7bcf" ON public."user-profile" USING btree (id);
...
ALTER TABLE "event"
            ADD PRIMARY KEY (id);  ALTER TABLE "event"
            ADD FOREIGN KEY (creator_id) REFERENCES "user-profile"(id);  CREATE UNIQUE INDEX "PK_30c2f3bbaf6d34a55f8ae6e4614" ON public.event USING btree (id);
...
ALTER TABLE "ipfs"
            ADD PRIMARY KEY (id);  CREATE UNIQUE INDEX "PK_af553336f95ba7f14152e2048ee" ON public.ipfs USING btree (id);
CREATE INDEX "IDX_fe9f97ee018e50ccb5d5255f56" ON public.ipfs USING btree (cid);
CREATE INDEX "IDX_f148f9547be0e098ecc0ec27db" ON public.ipfs USING btree (mime_type);
CREATE INDEX "IDX_23428c03d5433c30783c9efe4a" ON public.ipfs USING btree (file_name);
...
ALTER TABLE "user_posts_post"
            ADD PRIMARY KEY (user_id, post_id);  ALTER TABLE "user_posts_post"
            ADD FOREIGN KEY (user_id) REFERENCES "user"(id) ON UPDATE CASCADE ON DELETE CASCADE;  ALTER TABLE "user_posts_post"
            ADD FOREIGN KEY (post_id) REFERENCES post(id);  CREATE UNIQUE INDEX "PK_c46184b54cfec2342e1c575b00b" ON public.user_posts_post USING btree (user_id, post_id);
CREATE INDEX "IDX_42791e638b2f587a61232e6408" ON public.user_posts_post USING btree (user_id);
CREATE INDEX "IDX_557997292328c6f127dbee211b" ON public.user_posts_post USING btree (post_id);

CREATE TABLE "game_team_user" (
  "game_id" uuid NOT NULL,
  "user_id" uuid NOT NULL
);

ALTER TABLE "game_team_user"
            ADD PRIMARY KEY (game_id, user_id);  ALTER TABLE "game_team_user"
            ADD FOREIGN KEY (game_id) REFERENCES game(id) ON UPDATE CASCADE ON DELETE CASCADE;  ALTER TABLE "game_team_user"
            ADD FOREIGN KEY (user_id) REFERENCES "user"(id) ON UPDATE CASCADE ON DELETE CASCADE;  CREATE UNIQUE INDEX "PK_202cf19a556a132e1dff266b7ad" ON public.game_team_user USING btree (game_id, user_id);
CREATE INDEX "IDX_dea2174a735e6547fa42537015" ON public.game_team_user USING btree (game_id);
CREATE INDEX "IDX_359197ec4d167804a84586689b" ON public.game_team_user USING btree (user_id);

CREATE TABLE "game_editors_user" (
  "game_id" uuid NOT NULL,
  "user_id" uuid NOT NULL
);

ALTER TABLE "game_editors_user"
            ADD PRIMARY KEY (game_id, user_id);  ALTER TABLE "game_editors_user"
            ADD FOREIGN KEY (game_id) REFERENCES game(id) ON UPDATE CASCADE ON DELETE CASCADE;  ALTER TABLE "game_editors_user"
            ADD FOREIGN KEY (user_id) REFERENCES "user"(id) ON UPDATE CASCADE ON DELETE CASCADE;  CREATE UNIQUE INDEX "PK_214626b3d397af569e87a86a9d2" ON public.game_editors_user USING btree (game_id, user_id);
CREATE INDEX "IDX_6e34a3d0ce4c6be0f42c4ad3ef" ON public.game_editors_user USING btree (game_id);
CREATE INDEX "IDX_c502bad85d59f1c288baa97c4f" ON public.game_editors_user USING btree (user_id);

CREATE TABLE "user_roles" (
  "id" uuid NOT NULL DEFAULT uuid_generate_v4(),
  "created_at" timestamp without time zone NOT NULL DEFAULT now(),
  "updated_at" timestamp without time zone NOT NULL DEFAULT now(),
  "role" character varying NOT NULL DEFAULT 'CONTENT_OWNER'::character varying,
...
ALTER TABLE "user_roles"
            ADD PRIMARY KEY (id);  ALTER TABLE "user_roles"
            ADD FOREIGN KEY (user_id) REFERENCES "user"(id);  ALTER TABLE "user_roles"
            ADD UNIQUE (user_id, role, resource_id, resource_type);  CREATE UNIQUE INDEX "PK_8acd5cf26ebd158416f477de799" ON public.user_roles USING btree (id);
CREATE INDEX "IDX_0475850442d60bd704c5804155" ON public.user_roles USING btree (role);
CREATE INDEX "IDX_dd3f70fdb9082542d648df377b" ON public.user_roles USING btree (resource_id);
CREATE INDEX "IDX_4d94147dd97fb22ec638c7fa34" ON public.user_roles USING btree (resource_type);
CREATE UNIQUE INDEX user_role_resource ON public.user_roles USING btree (user_id, role, resource_id, resource_type);
...
CREATE TABLE "game" (
  ...
  "visibility" "game_visibility_enum" NOT NULL DEFAULT 'DRAFT'::game_visibility_enum,
  "body" text NOT NULL,
  "thumbnail" character varying(1024) DEFAULT ''::character varying,
  "owner_id" uuid NOT NULL
);

ALTER TABLE "game"
            ADD PRIMARY KEY (id);  ALTER TABLE "game"
            ADD FOREIGN KEY (owner_id) REFERENCES "user"(id);  CREATE UNIQUE INDEX "PK_352a30652cd352f552fef73dec5" ON public.game USING btree (id);
CREATE INDEX "IDX_8ea221926a26ee68a25c904b65" ON public.game USING btree (visibility);
CREATE UNIQUE INDEX "IDX_b9af94cf126ec9f9b2e3523736" ON public.game USING btree (slug);
CREATE INDEX "IDX_0152ed47a9e8963b5aaceb51e7" ON public.game USING btree (title);
...
CREATE TABLE "game_feedback_response" (
  "id" uuid NOT NULL DEFAULT uuid_generate_v4(),
  "created_at" timestamp without time zone NOT NULL DEFAULT now(),
  "updated_at" timestamp without time zone NOT NULL DEFAULT now(),
  "version_id" uuid,
...
ALTER TABLE "game_feedback_response"
            ADD PRIMARY KEY (id);  ALTER TABLE "game_feedback_response"
            ADD FOREIGN KEY (version_id) REFERENCES game_version(id);  ALTER TABLE "game_feedback_response"
            ADD FOREIGN KEY (user_id) REFERENCES "user"(id);  CREATE UNIQUE INDEX "PK_06ba706538a5547bd21671dc818" ON public.game_feedback_response USING btree (id);
...
ALTER TABLE "game_version"
            ADD PRIMARY KEY (id);  ALTER TABLE "game_version"
            ADD FOREIGN KEY (game_id) REFERENCES game(id);  ALTER TABLE "game_version"
            ADD UNIQUE (version, game_id);  CREATE UNIQUE INDEX "PK_272f36b21fb4f0c43edd12fcfbe" ON public.game_version USING btree (id);
CREATE INDEX "IDX_53d4ec636b3f0119f63a20cad8" ON public.game_version USING btree (feedback_deadline);
CREATE UNIQUE INDEX "UQ_9231b15cd2768c08bc08b464042" ON public.game_version USING btree (version, game_id);
