// import { Body, Controller, Logger, UnauthorizedException } from '@nestjs/common';
...
//   },
//   routes: {
//     exclude: ['replaceOneBase', 'updateOneBase', 'createManyBase', 'recoverOneBase'],
//     getOneBase: {
...
// export class ProjectVersionController implements CrudController<ProjectVersionEntity> {
...
//     @Body(new ExcludeFieldsPipe<ProjectVersionEntity>(['createdAt', 'updatedAt', 'id', 'responses']))
//     dto: PartialWithoutFields<ProjectVersionEntity, 'createdAt' | 'updatedAt' | 'id' | 'responses'>,
...
//     if (await this.gameService.UserCanEdit(user.id, dto.project.id)) return this.base.createOneBase(req, <ProjectVersionEntity>dto);
//     else throw new UnauthorizedException('User does not have permission to edit this game');
//   }
//
//   @Override()
//   @Auth(AuthenticatedRoute)
...
//
//     // todo: move this to a decorator
//     if (await this.gameService.UserCanEdit(user.id, dto.project.id)) return this.base.deleteOneBase(req);
//     else throw new UnauthorizedException('User does not have permission to delete this game');
//   }
// }
