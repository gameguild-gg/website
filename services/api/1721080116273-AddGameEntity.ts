...
export class AddGameEntity1721080116273 implements MigrationInterface {
    name = 'AddGameEntity1721080116273'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "game_version" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "version" character varying NOT NULL, "archive_url" character varying NOT NULL, "notes_url" character varying NOT NULL, "feedback_form" character varying NOT NULL, "deadline" TIMESTAMP WITH TIME ZONE NOT NULL, "game_id" uuid, CONSTRAINT "PK_272f36b21fb4f0c43edd12fcfbe" PRIMARY KEY ("id"))`);
