...
import { QuestionBasev1_0_0, QuestionStatus, CodeQuestionv1_0_0, AnswerQuestionv1_0_0, MultipleChoiceQuestionv1_0_0, EssayQuestionv1_0_0 } from '@/lib/interface-base/question.base.v1.0.0'
    ...
    try {
      ...
      const processedQuestions = allQuestionData.map(question => {
        if (question.type === 'code') {
          const codeQuestion = question as CodeQuestionv1_0_0;
          return {
            ...codeQuestion,
            initialCode: Object.values(codeQuestion.initialCode)[0],
            codeName: codeQuestion.codeName[0].name
          };
        }
        return question;
      });
      ...
      updateCurrentTabQuestions(assessmentData, processedQuestions, activeTab)
    } catch (error) {
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className={`flex flex-col md:flex-row gap-8 bg-white dark:bg-gray-800 high-contrast:bg-black rounded-b-lg shadow-lg overflow-hidden border-t border-gray-200 dark:border-gray-600 high-contrast:border-yellow-300`}>
          ...
          <div className="w-full md:w-2/3 p-8">
            {selectedQuestion ? (
              <QuestionDetail
                question={selectedQuestion as CodeQuestionv1_0_0}
