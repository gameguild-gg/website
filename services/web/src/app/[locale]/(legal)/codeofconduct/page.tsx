...
export default async function Page() {
  return (
    ...
    <p>
        ...
        <a href="discord.com">discord.com</a>, by user @tolstenko. The project team will review and investigate all complaints, 
        and will respond in a way that it deems appropriate to the circumstances. The project team is obligated to maintain 
