...
export class AuthController {
    ...
    public async registerEmailPassword(@Body() data: UserLoginDto): Promise<UserEntity> {
    ...
    public async loginEmailPassword(@Body() data: UserLoginDto): Promise<TokenPayloadDto> {
