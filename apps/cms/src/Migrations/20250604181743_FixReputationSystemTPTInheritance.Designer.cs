...
namespace cms.Migrations
{
    ...
    [Migration("20250604181743_FixReputationSystemTPTInheritance")]
    partial class FixReputationSystemTPTInheritance
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("cms.Modules.Reputation.Models.ReputationLevel", b =>
                {
                    b.HasBaseType("cms.Common.Entities.ResourceBase");
            ...
            modelBuilder.Entity("cms.Modules.Reputation.Models.UserReputation", b =>
                {
                    ...
                    b.Property<Guid?>("ReputationLevelId")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("cms.Modules.Reputation.Models.ReputationAction", b =>
                {
                    ...
                    b.HasOne("cms.Modules.Reputation.Models.ReputationLevel", "RequiredLevel")
                        .WithMany()
            ...
            modelBuilder.Entity("cms.Modules.Reputation.Models.ReputationLevel", b =>
                {
                    b.HasOne("cms.Common.Entities.ResourceBase", null)
                        .WithOne()
                        .HasForeignKey("cms.Modules.Reputation.Models.ReputationLevel", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("cms.Modules.Reputation.Models.UserReputation", b =>
                {
                    b.HasOne("cms.Modules.Reputation.Models.ReputationLevel", "CurrentLevel")
                        .WithMany()
                    ...
                    b.HasOne("cms.Modules.Reputation.Models.ReputationLevel", null)
                        .WithMany("UserReputations")
                        .HasForeignKey("ReputationLevelId");
            ...
            modelBuilder.Entity("cms.Modules.Reputation.Models.UserReputationHistory", b =>
                {
                    ...
                    b.HasOne("cms.Modules.Reputation.Models.ReputationLevel", "NewLevel")
                        .WithMany()
                        .HasForeignKey("NewLevelId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("cms.Modules.Reputation.Models.ReputationLevel", "PreviousLevel")
                        .WithMany()
