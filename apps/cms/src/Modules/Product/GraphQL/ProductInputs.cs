...
using PromoCodeTypeEnum = cms.Common.Enums.PromoCodeType;

namespace cms.Modules.Product.GraphQL;

public class CreateProductInput
{
    public required string Name { get; set; }
    public string? ShortDescription { get; set; }
    public required cms.Common.Enums.ProductType Type { get; set; }
...
public class UpdateProductInput
{
    ...
    public cms.Common.Enums.ProductType? Type { get; set; }
    public bool? IsBundle { get; set; }
    public ContentStatus? Status { get; set; }
    public cms.Common.Entities.Visibility? Visibility { get; set; }
}
