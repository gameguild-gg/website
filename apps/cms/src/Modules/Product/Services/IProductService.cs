...
public interface IProductService
{
    ...
    Task<ProductEntity> SetVisibilityAsync(Guid id, cms.Common.Entities.Visibility visibility);
    ...
    Task<int> GetProductCountAsync(ProductType? type = null, cms.Common.Entities.Visibility? visibility = null);
