      ...
      <div className="flex justify-between my-0 px-0 py-0 h-full w-full mx-auto">
        ...
        <div className="flex my-0 py-0">
          <a href="/" className="flex my-0 py-0">
            <img src="/assets/images/logo-text.png" className="w-[135px] h-46px my-auto mx-[10px]" />
          </a>
          <a href="/chess" className="flex my-0 font-semibold hover:bg-neutral-800 px-2 min-w-[80px] hover:text-yellow-400">
            <span className="m-auto ">Feed</span>
          </a>
          <a href="/games" className="flex my-0 font-semibold hover:bg-neutral-800 px-2 min-w-[80px] hover:text-yellow-400">
          ...
          <a href="/gtl" className="flex my-0 font-semibold hover:bg-neutral-800 px-2 min-w-[80px] hover:text-green-400">
            <span className="m-auto ">GTL</span>
          </a>
          <a href="/jams" className="flex my-0 font-semibold hover:bg-neutral-800 px-2 min-w-[80px] hover:text-purple-400">
          ...
          <a href="/Community" className="flex my-0 font-semibold hover:bg-neutral-800 px-2 min-w-[80px] hover:text-red-400">
        ...
        <div className="flex items-center space-x-4">
          <div className="relative">
            <Input type="search" placeholder="Search for games or creators" className="pl-10 pr-4 py-2 rounded-full bg-gray-100" />
