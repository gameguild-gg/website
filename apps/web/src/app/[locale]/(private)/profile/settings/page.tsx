        ...
        <main className="flex-1">
          ...
          <form className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Input
                id="url"
                value="https://gameguild.gg/u/username"
                readOnly
              />
            </div>
            <div className="space-y-2">
              <Label>
                Profile Image — Shown next to your name when you take an action
                on the site (square dimensions)
              </Label>
            ...
            <div className="space-y-2">
              <Label htmlFor="language">
                Language — Language of gameguild user interface
              </Label>
              <Select>
                <SelectTrigger>
              ...
              <p className="text-sm text-muted-foreground">
                gameguild is translated by members of our community. Some
                languages are only partially available. If you'd like to see
                gameguild in your language or help fix any mistakes you can
                contribute.{' '}
