  ...
  return (
    <div className="w-full min-h-screen bg-black">
      <div className="max-w-[1440px] mx-auto px-4 py-12">
        ...
        <div
          className="flex flex-col md:flex-row justify-center items-center md:space-x-12 space-y-8 md:space-y-0 mt-16">
          <a
            href="/gtl/owner"
          ...
          >
            ...
            />
            <p
              className="mt-4 text-2xl font-semibold text-center text-white group-hover:text-green-600 transition-all duration-300">
              Build a Game
            </p>
          </a>
          <a
