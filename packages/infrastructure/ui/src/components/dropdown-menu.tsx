...
function DropdownMenuTrigger({ asChild, children, render, ...props }: MenuPrimitive.Trigger.Props & { asChild?: boolean }) {
  return <MenuPrimitive.Trigger data-slot="dropdown-menu-trigger" render={asChild && React.isValidElement(children) ? children : render} {...props}>{asChild ? null : children}</MenuPrimitive.Trigger>
}
